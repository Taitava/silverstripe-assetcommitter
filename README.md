...
5. Remember to run `?flush=all` in your browser to clear cache!

## Extending via hooks

There are currently two hooks you can use to customise the behaviour of this module:
...
And finally remember to run `?flush=all` in your browser to clear cache!
